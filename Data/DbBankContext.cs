...
public partial class DbBankContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=REYKMTM\\SQLEXPRESS;Initial Catalog=DBBank;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        }
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC271AF852ED");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC27108DA74B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC27DC3120F4");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC274C75DA09");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC27EE5530F4");
